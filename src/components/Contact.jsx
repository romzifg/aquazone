      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative' }}>
        ...
        <div ref={ref} style={{
          ...
          <div style={{
            ...
            <div style={{ minWidth: 230 }} className="hide-mobile">
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>

                {/* WhatsApp */}
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                  <div style={{ width: 36, height: 36, borderRadius: 8, flexShrink: 0, background: 'rgba(37,211,102,0.12)', border: '1px solid rgba(37,211,102,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                {/* Instagram */}
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                  <div style={{ width: 36, height: 36, borderRadius: 8, flexShrink: 0, background: 'rgba(225,48,108,0.12)', border: '1px solid rgba(225,48,108,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                {/* Facebook */}
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                  <div style={{ width: 36, height: 36, borderRadius: 8, flexShrink: 0, background: 'rgba(24,119,242,0.12)', border: '1px solid rgba(24,119,242,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
