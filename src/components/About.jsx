      ...
      <div ref={ref} style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ fontSize: 11, fontWeight: 600, color: '#0ea5e9', letterSpacing: '0.18em', textTransform: 'uppercase', marginBottom: 16 }}>
              Our Story
            </p>
            <h2 style={{
              fontSize: 'clamp(26px,3.6vw,42px)', fontWeight: 700,
              color: '#0f2537', lineHeight: 1.18, marginBottom: 18, letterSpacing: '-0.5px',
            }}>
              From a farm in Bojongsari<br />
              <span style={{ color: '#0ea5e9' }}>to the global market.</span>
            </h2>
            <div style={{ width: 44, height: 2, background: 'linear-gradient(90deg,#0ea5e9,transparent)', marginBottom: 26 }} />

            <p style={{ fontSize: 14.5, lineHeight: 1.9, color: 'rgba(35,74,100,0.68)', marginBottom: 18, fontWeight: 300 }}>
            ...
            <p style={{ fontSize: 14.5, lineHeight: 1.9, color: 'rgba(35,74,100,0.68)', marginBottom: 28, fontWeight: 300 }}>
            ...
            <div style={{
              ...
              <p style={{ fontSize: 13, lineHeight: 1.78, color: 'rgba(35,74,100,0.68)', fontWeight: 300 }}>
          ...
          <div style={{
            ...
            <div style={{ position: 'relative', paddingLeft: 36 }}>
              ...
              <div style={{
                ...
                width: 1, background: 'linear-gradient(to bottom, #0ea5e9, rgba(59,130,246,0.1))',
              }} />
              ...
              {TIMELINE.map((item, i) => (
                <div key={item.year} style={{ marginBottom: i < TIMELINE.length - 1 ? 36 : 0, position: 'relative' }}>
                  ...
                  <div style={{
                    ...
                    background: i === TIMELINE.length - 1 ? '#f59e0b' : '#0ea5e9',
                    border: `2px solid ${i === TIMELINE.length - 1 ? '#f59e0b' : '#0ea5e9'}`,
                    boxShadow: `0 0 8px ${i === TIMELINE.length - 1 ? 'rgba(245,158,11,0.4)' : 'rgba(59,130,246,0.35)'}`,
                  }} />
                  <div style={{ fontSize: 11.5, fontWeight: 600, color: i === TIMELINE.length - 1 ? '#f59e0b' : '#0ea5e9', letterSpacing: '0.1em', marginBottom: 4 }}>
                    {item.year}
                  </div>
                  <div style={{ fontSize: 15, fontWeight: 600, color: '#15384f', marginBottom: 6 }}>{item.title}</div>
                  <p style={{ fontSize: 13.5, lineHeight: 1.72, color: 'rgba(35,74,100,0.62)', fontWeight: 300 }}>{item.desc}</p>
                </div>
              ))}
            </div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
                <div>
                  <div style={{ fontSize: 26, fontWeight: 800, color: '#0ea5e9', letterSpacing: '-0.5px', lineHeight: 1 }}>~2M</div>
                  <div style={{ fontSize: 11, color: 'rgba(35,74,100,0.56)', marginTop: 4, fontWeight: 400 }}>fish / month capacity</div>
                </div>
                <div style={{ width: 1, background: 'rgba(59,130,246,0.2)' }} />
                <div>
                  <div style={{ fontSize: 26, fontWeight: 800, color: '#0ea5e9', letterSpacing: '-0.5px', lineHeight: 1 }}>20+</div>
                  <div style={{ fontSize: 11, color: 'rgba(35,74,100,0.56)', marginTop: 4, fontWeight: 400 }}>partner farmers & breeders</div>
                </div>
              </div>
            </div>
          </div>
